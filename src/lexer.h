...
enum lexer_ctx
{
	LEXER_CTX_C_SOURCE,	/* inside C source */
	LEXER_CTX_CPP_SOURCE,	/* inside C preprocessor source */
	LEXER_CTX_PP_INCLUDE,	/* inside an #include directive */
};
...
struct lexer
{
	...
	enum lexer_ctx context;	/* lexer context */
